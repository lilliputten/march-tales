...
- See issues: [#69](https://github.com/lilliputten/march-tales/issues/69).
- Added an `application` page with two-language content and previews gallery (with translated captions).
