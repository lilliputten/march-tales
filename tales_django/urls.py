from .entities.App.app_urlpatterns import app_urlpatterns, handler403, handler404, handler500, i18n_urlpatterns
...
from .entities.Tracks.track_urlpatterns import track_api_urlpatterns, track_urlpatterns
