# Generated by Django 5.1.4 on 2024-12-31 21:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.TextField(help_text='Required. 150 characters or fewer. Track title', max_length=150, unique=True, verbose_name='track title')),
                ('description', models.TextField(blank=True, max_length=512, verbose_name='description')),
                ('youtube_url', models.URLField(blank=True, max_length=150)),
                ('tags_list', models.TextField(blank=True, max_length=150)),
                ('preview_picture', models.ImageField(upload_to='tracks')),
                ('audio_file', models.FileField(upload_to='tracks')),
                ('track_status', models.TextField(choices=[('HIDDEN', 'Hidden'), ('PUBLISHED', 'Published')], default='HIDDEN')),
